...
onSubmitEdit = e =>{
   ...
   //for Add an attachment in edit the article 
...
//for create a new article
   submitHandler = e =>{
       ...
       if(this.state.attachments!=null){
         form_data.append('attachments', this.state.attachments, this.state.attachments.name);
       } else form_data.append('attachments', this.state.attachments);
    form_data.append('title', this.state.title);
    form_data.append('content', this.state.content);
    let url = `${API_URL}/new/`;
    axios.post(url, form_data, {
                            ...
                            <div className="row">
                                 {
                                      ...
                                      <div className="col-md-6" key={post.id}>
                                        ...
                                        <div className="card-header">
                                            ...
                                            <button type="button" className="btn" onClick={() =>this.onClickGet(post.id)} data-toggle="modal" data-target="#editModal" style={blueStyle} >
                                            ...
                                            <button type="button" className="btn " onClick={() =>{ if (window.confirm('Are you sure you wish to delete this article?')) this.onClickDelete(post.id) } }><i className="fas fa-trash-alt"/></button>
